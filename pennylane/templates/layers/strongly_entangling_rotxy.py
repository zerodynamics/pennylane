...
r"""
Contains the ``StronglyEntanglingLayersRotXY`` template.
"""
# pylint: disable-msg=too-many-branches,too-many-arguments,protected-access
import pennylane as qml
from pennylane.templates.decorator import template
from pennylane.ops import CNOT, RotXY, Rot
...
def _preprocess(weights, wires, ranges):
    ...
    * If ranges is None, define a default.
    ...
    if qml.tape_mode_active():
        ...
        expected_shape = (repeat, len(wires), 2)
        check_shape(
            weights,
            expected_shape,
...
#zer0dynamics
@template
def StronglyEntanglingLayersRotXY(weights, wires, ranges=None, imprimitive=CNOT):
    ...
    Args:
        ...
        weights (tensor_like): weight tensor of shape ``(L, M, 2)``
    ...
    for l in range(repeat):
        ...
        strongly_entangling_layer_rotxy(
